...
import shopexample.domain.InventoryDecreased;
import shopexample.domain.InventoryIncreased;
...
public class Inventory {
    ...
    public static void decreaseInventory(DeliveryStrated deliveryStrated) {
        /** Example 1:  new item 
        ...
        */
        ...
        repository().findById(deliveryStrated.get???()).ifPresent(inventory->{
